...
#### Phase 5.5：助记功能 ✅
- [x] 复习页翻卡后显示"💡 助记"按钮
- [x] AI 生成记忆方法（词根拆词/谐音联想/画面联想/同根词串记）
- [x] 结果缓存到 IndexedDB（mnemonic 字段）
- [x] 展示区可收起/展开 + 简易 Markdown 渲染
- [x] Code review: callAPI 提取、renderMnemonicText 模块化 + 12 测试

#### Phase 5.6：深色模式 ✅
- [x] 三种模式：☀️浅色 / 🌙深色 / 🔄跟随系统（默认 auto）
- [x] CSS 变量覆盖 + 20+ 硬编码颜色适配
- [x] 设置页顶部"外观"切换按钮
- [x] 首次加载无闪白（head 内联脚本）
- [x] Code review: CSS 去重、!important 清理、scroll 节流
